# NB Geo-AI: Automated Geological Contact Mapping

This repository contains the interactive dashboard for the **Deep Learning Segmentation of Airborne Geophysical Data Across New Brunswick** project.
