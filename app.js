document.addEventListener('DOMContentLoaded', () => {
    ...
    aiPredictedLines.forEach(coords => {
        ...
        }).bindTooltip("U-Net Predicted Contact<br>Conf: 94%", {className: 'custom-tooltip'})
    ...
    revisionZones.forEach(coords => {
        ...
        }).bindTooltip("<b style='color:#fca5a5;'>Priority Revision Zone</b><br>Disagreement: >500m<br>AI Confidence: High", {className: 'custom-tooltip'})
          .addTo(priorityGroup);
    });
